...
const sqlImportUpdate = file => sqlImport(sqlImport("update", file))
...
export const INSERT_USER_SONG = sqlImportInsert("userSong")
export const INSERT_SONG_GENRE = sqlImportInsert("songGenre")
export const INSERT_USER_ALBUM = sqlImportInsert("userAlbum")
export const INSERT_USER_GENRE = sqlImportInsert("userGenre")
export const INSERT_USER_ARTIST = sqlImportInsert("userArtist")
...
export const SELECT_USER_ALBUM_ADDED = sqlImportSelect("userAlbumAdded")
export const SELECT_USER_ALBUM_IN_LIB = sqlImportSelect("userAlbumInLib")
export const SELECT_USER_ALBUM_EXISTS = sqlImportSelect("userAlbumExists")

export const COLUMN_EXISTS = sqlImportExists("column")
export const ALBUM_SONG_EXISTS = sqlImportExists("albumSong")
export const USER_LIBRARY_EXISTS = sqlImportExists("userLibrary")

export const UPDATE_USER_SONG_IN = sqlImportUpdate("userSongIn")
export const UPDATE_USER_ALBUM_IN = sqlImportUpdate("userAlbumIn")
export const UPDATE_USER_GENRE_IN = sqlImportUpdate("userGenreIn")
export const UPDATE_USER_ARTIST_IN = sqlImportUpdate("userArtistIn")
