...
export const AddToCatalogArtist = componentClassNames("AddToCatalogArtist")
export const AddToCatalogAlbum = componentClassNames("AddToCatalogAlbum")
export const AddToCatalogSong = componentClassNames("AddToCatalogSong")
