...
export const SELECT_USER_PASSWORD = importFile("userPassword")
export const SELECT_USER_SONGS_ALL = importFile("userSongsAll")
...
export const SELECT_USER_PLAYLISTS_FILTERED = importFile("userPlaylistsFiltered")